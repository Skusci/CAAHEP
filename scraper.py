...
def parse_results(html):
    ...
    for r in programlist.findAll('li', recursive=False):
        ...
        Address = r.find('div', attrs={'class' : 'program-address col-md-6 col-sm-6 col-xs-6'}).contents[0].string
        
        ProgInfo = r.find('div', attrs={'class' : 'program-info col-md-6 col-sm-6 col-xs-6'}).contents[0].string
        Website = r.find('h4', attrs={'class' : 'website'}).contents[0].string
